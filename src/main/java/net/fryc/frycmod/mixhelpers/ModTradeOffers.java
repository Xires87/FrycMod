package net.fryc.frycmod.mixhelpers;
...
public class ModTradeOffers extends TradeOffers{
    ...
    public static final Map<VillagerProfession, Int2ObjectMap<Factory[]>> PROFESSION_TO_LEVELED_TRADE = (Map) Util.make(Maps.newHashMap(), (map) -> {
        ...
        map.put(VillagerProfession.CLERIC, ModTradeOffers.copyToFastUtilMap(ImmutableMap.of(1, new Factory[]{new ModTradeOffers.BuyForOneEmeraldFactory(Items.ROTTEN_FLESH, 32, 16, 2), new ModTradeOffers.SellItemFactory(ModItems.BANDAGE, 2, 1, 2)}, 2, new Factory[]{new ModTradeOffers.BuyForOneEmeraldFactory(Items.GOLD_INGOT, 4, 12, 10), new ModTradeOffers.SellItemFactory(Items.LAPIS_LAZULI, 1, 1, 5)}, 3, new Factory[]{new ModTradeOffers.BuyForOneEmeraldFactory(Items.RABBIT_FOOT, 2, 12, 20), new ModTradeOffers.SellItemFactory(Blocks.GLOWSTONE, 4, 1, 12, 10), new ModTradeOffers.SellItemFactory(ModItems.HONEY_BANDAGE , 4 , 1 ,10)}, 4, new Factory[]{new ModTradeOffers.BuyForOneEmeraldFactory(Items.SCUTE, 4, 12, 30), new ModTradeOffers.BuyForOneEmeraldFactory(Items.GLASS_BOTTLE, 9, 12, 30), new ModTradeOffers.SellItemFactory(Items.ENDER_PEARL, 5, 1, 15)}, 5, new Factory[]{new ModTradeOffers.BuyForOneEmeraldFactory(Items.NETHER_WART, 22, 12, 30), new ModTradeOffers.SellItemFactory(Items.EXPERIENCE_BOTTLE, 3, 1, 30)})));
