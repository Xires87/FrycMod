...
public class ModSpawnEggs {
    ...
    public static void registerSpawnEggs(){
        ...
        //biome variants
        Registry.register(Registry.ITEM, new Identifier(FrycMod.MOD_ID, "explorer_spawn_egg"), EXPLORER_SPAWN_EGG);
        Registry.register(Registry.ITEM, new Identifier(FrycMod.MOD_ID, "tropical_spider_spawn_egg"), TROPICAL_SPIDER_SPAWN_EGG);

        //nether variants
        Registry.register(Registry.ITEM, new Identifier(FrycMod.MOD_ID, "executioner_spawn_egg"), EXECUTIONER_SPAWN_EGG);
        Registry.register(Registry.ITEM, new Identifier(FrycMod.MOD_ID, "nightmare_spawn_egg"), NIGHTMARE_SPAWN_EGG);
